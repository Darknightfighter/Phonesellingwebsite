                ...
                <table class="manauser-table">
                    ...
                    <!--<c:forEach var="item" items="${Cart}">
                        <tr class="table-product">
                            ...
                            <th><input type="text" class="form-control" value="${item.LineItem.Product.color}" readonly></th>
    ...
    Object.values(buttons).forEach(({ button, saveButton }) => {
        button.addEventListener('click', function() {
            if (button.id === 'add-button') {
                ...
                newRow.innerHTML = `
                    <th><input type="number" class="form-control" value="" placeholder="Cart ID"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Order Date"></th>
                    ...
                    <th><input type="text" class="form-control" value="" placeholder="status"></th>
                    <th><i class="bi bi-trash" id="delete"></i></th>
                `;
