            ...
            <div class="manauser-inner">
                <table class="manauser-table">
                    ...
                    <tr class="table-user">
                        ...
                        <th><input type="email" class="form-control" value="walterbs3556@gmail.com" readonly></th>
                    ...
                    <tr class="table-user">
                        ...
                        <th><input type="text" class="form-control" value="Male" readonly></th>
                        <th><input type="text" class="form-control" value="0987654321" readonly></th>
                        <th><input type="email" class="form-control" value="ted911@gmail.com" readonly></th>
                    ...
                    <!--<c:forEach var="item" items="${User}">
                        <tr class="table-product">
                            ...
                            <th><input type="text" class="form-control" value="${item.fullname}" readonly></th>
                            <th><input type="text" class="form-control" value="${item.gender}" readonly></th>
                            <th><input type="text" class="form-control" value="${item.phoneNumber}" readonly></th>
                            <th><input type="email" class="form-control" value="${item.email}" readonly></th>
                            <th><input type="text" class="form-control" value="${item.address}" readonly></th>
                            <th><input type="text" class="form-control" value="${item.password}" readonly></th>
                            <th><i class="bi bi-trash" id="delete"></i></th>
                        </tr>
                    </c:forEach>-->
                </table>
    ...
    Object.values(buttons).forEach(({ button, saveButton }) => {
        button.addEventListener('click', function() {
            if (button.id === 'add-button') {
                ...
                newRow.innerHTML = `
                    <th><input type="number" class="form-control" value="" placeholder="User ID"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Full Name"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Gender"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Phone Number"></th>
                    <th><input type="email" class="form-control" value="" placeholder="Email"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Address"></th>
                    <th><input type="text" class="form-control" value="" placeholder="Password"></th>
                    <th><i class="bi bi-trash" id="delete"></i></th>
                `;
        ...
        saveButton.addEventListener('click', function(event) {
            ...
            if (newRow) {
                ...
                var genderInput = newRow.querySelector('input[placeholder="Gender"]');
                var genderValue = genderInput.value.toLowerCase();
